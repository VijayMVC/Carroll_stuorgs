...
/****** Object:  StoredProcedure [dbo].[sp_GetStudentByID]    Script Date: 02/08/2013 09:50:32 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    SELECT Student.LastName, Student.FirstName, Student.Student_ID ,Student.Carroll_ID,
